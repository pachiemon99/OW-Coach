...
const dbPath=path.join(root,'data/shared/owcoach_depth_enhancement_db_v50_17.csv');
const auditPath=path.join(root,'data/audits/owcoach_db_quality_score_audit_v50_17.csv');
...
must(['50.17.0','50.18.0','50.19.0','50.20.0','50.21.0','50.22.0','50.23.0'].includes(pkg.version),`package version should be 50.17.0, got ${pkg.version}`);
