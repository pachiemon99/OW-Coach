...
const contractPath = path.join(root, 'data/contracts/owcoach_ultimate_decision_contract_v50_6.json');
const csvPath = path.join(root, 'data/shared/owcoach_ultimate_decision_db_v50_6.csv');
