...
const audit=path.join(root,'data/audits/owcoach_db_quality_score_audit_v50_16.csv');
...
must(['50.16.0','50.17.0','50.18.0','50.19.0','50.20.0','50.21.0','50.22.0','50.23.0'].includes(pkg.version),`package version should be 50.16.0, got ${pkg.version}`);
